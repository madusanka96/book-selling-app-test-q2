...
class Main extends Component {
  ...
  componentDidMount = async() => {
   const res = await fetch('https://api.nytimes.com/svc/books/v3/lists/current/hardcover-fiction.json?api-key=HXEBrsF2lIIw2ggr6RGQZ8l0fQBA2ZSk')
        ...
        <React.Fragment>
          ...
          this.state.books.map((book) => (
            ...
            <div className="card-body">
              ...
              <Link to={{ pathname: '/simple', state: { dataBook: book} }} className="btn btn-primary">More Details</Link>
            </div>
            </div>
            </div>
